...
class King(ChessPiece):
    ...
    def potential_moves(self, current_position):
        ...
        if squares[current_position].has_been_moved == False:
            ...
            if squares[current_position].color == "White":
                ...
                if squares[rook_position]:
                    if squares[rook_position].has_been_moved == False:
                        for i in 1, 2:
                    ...
                    if all(check == False for check in in_between_positions):
...
class Pawn(ChessPiece):
    ...
    def potential_moves(self, current_position):
        ...
        if (piece_color == 'Black' and 
            squares[current_position].has_been_moved == False):
...
def move_piece(current_position, new_position):
    ...
    if squares[new_position].has_been_moved == False:
